   ...
   ThermoLiq *liquid, ThermoData *fusion, ThermoData *result)
{
   ...
   /* Solids : Special cases handled first!
      (Oxygen gas and Water are included in this section)                    */

   if(strcmp(name, "o2") == 0) {
#ifdef SPECIAL_O2
      getO2properties(t, p, &gs, &hs, &ss, &cps, &dcpsdt, &vs, &dvsdt, &dvsdp,
        &d2vsdt2, &d2vsdp2, &d2vsdtdp);
