...
int main (int argc, char *argv[]) {
  ...
  strcpy(string, "cd Bishop_runs; mkdir LBT+1_000; cd LBT+1_000;");
  ...
  strcpy(string, "cd Bishop_runs; cd LBT+1_000;");
  ...
  strcpy(string, "cd Bishop_runs; mkdir LBT+1_001; cd LBT+1_001;");
  strcat(string, "mkdir 400; cd 400; ulimit -t 30; /Users/ghiorso/Documents/ARCHIVE_CODE/xMelts/Test_commandLib ");
  strcat(string, "75.51 0.21 13.0 0.0000 1.1000 0.25 0.95 3.35 5.55 4.74 0.001 4000.0");
  system(string);
  
  strcpy(string, "cd Bishop_runs; cd LBT+1_001;");
  strcat(string, "mkdir 375; cd 375; ulimit -t 30; /Users/ghiorso/Documents/ARCHIVE_CODE/xMelts/Test_commandLib ");
  ...
  strcpy(string, "cd Bishop_runs; mkdir LBT+1_002; cd LBT+1_002;");
  strcat(string, "mkdir 400; cd 400; ulimit -t 30; /Users/ghiorso/Documents/ARCHIVE_CODE/xMelts/Test_commandLib ");
  strcat(string, "75.51 0.21 13.0 0.0000 1.1000 0.25 0.95 3.35 5.55 4.74 0.002 4000.0");
  system(string);
  
  strcpy(string, "cd Bishop_runs; cd LBT+1_002;");
  strcat(string, "mkdir 375; cd 375; ulimit -t 30; /Users/ghiorso/Documents/ARCHIVE_CODE/xMelts/Test_commandLib ");
  ...
  strcpy(string, "cd Bishop_runs; mkdir LBT+1_005; cd LBT+1_005;");
  strcat(string, "mkdir 400; cd 400; ulimit -t 30; /Users/ghiorso/Documents/ARCHIVE_CODE/xMelts/Test_commandLib ");
  strcat(string, "75.51 0.21 13.0 0.0000 1.1000 0.25 0.95 3.35 5.55 4.74 0.005 4000.0");
  system(string);
  
  strcpy(string, "cd Bishop_runs; cd LBT+1_005;");
  strcat(string, "mkdir 375; cd 375; ulimit -t 30; /Users/ghiorso/Documents/ARCHIVE_CODE/xMelts/Test_commandLib ");
  ...
  strcpy(string, "cd Bishop_runs; mkdir LBT+1_010; cd LBT+1_010;");
  strcat(string, "mkdir 400; cd 400; ulimit -t 30; /Users/ghiorso/Documents/ARCHIVE_CODE/xMelts/Test_commandLib ");
  strcat(string, "75.51 0.21 13.0 0.0000 1.1000 0.25 0.95 3.35 5.55 4.74 0.010 4000.0");
  system(string);
  
  strcpy(string, "cd Bishop_runs; cd LBT+1_010;");
  strcat(string, "mkdir 375; cd 375; ulimit -t 30; /Users/ghiorso/Documents/ARCHIVE_CODE/xMelts/Test_commandLib ");
  ...
  strcpy(string, "cd Bishop_runs; mkdir LBT+1_020; cd LBT+1_020;");
  strcat(string, "mkdir 400; cd 400; ulimit -t 30; /Users/ghiorso/Documents/ARCHIVE_CODE/xMelts/Test_commandLib ");
  strcat(string, "75.51 0.21 13.0 0.0000 1.1000 0.25 0.95 3.35 5.55 4.74 0.020 4000.0");
  system(string);
  
  strcpy(string, "cd Bishop_runs; cd LBT+1_020;");
  strcat(string, "mkdir 375; cd 375; ulimit -t 30; /Users/ghiorso/Documents/ARCHIVE_CODE/xMelts/Test_commandLib ");
  ...
  strcpy(string, "cd Bishop_runs; mkdir LBT+1_050; cd LBT+1_050;");
  strcat(string, "mkdir 400; cd 400; ulimit -t 30; /Users/ghiorso/Documents/ARCHIVE_CODE/xMelts/Test_commandLib ");
  strcat(string, "75.51 0.21 13.0 0.0000 1.1000 0.25 0.95 3.35 5.55 4.74 0.050 4000.0");
  system(string);
  
  strcpy(string, "cd Bishop_runs; cd LBT+1_050;");
  strcat(string, "mkdir 375; cd 375; ulimit -t 30; /Users/ghiorso/Documents/ARCHIVE_CODE/xMelts/Test_commandLib ");
  ...
  strcpy(string, "cd Bishop_runs; mkdir LBT+1_100; cd LBT+1_100;");
  strcat(string, "mkdir 400; cd 400; ulimit -t 30; /Users/ghiorso/Documents/ARCHIVE_CODE/xMelts/Test_commandLib ");
  strcat(string, "75.51 0.21 13.0 0.0000 1.1000 0.25 0.95 3.35 5.55 4.74 0.100 4000.0");
  system(string);
  
  strcpy(string, "cd Bishop_runs; cd LBT+1_100;");
  strcat(string, "mkdir 375; cd 375; ulimit -t 30; /Users/ghiorso/Documents/ARCHIVE_CODE/xMelts/Test_commandLib ");
