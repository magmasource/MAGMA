...
clang++ -o easyMelts -std=c++17 -I/usr/local/include -I./include -I./include/imgui -I./include/melts ./src/*.cpp glad.o -L./lib -L/usr/local/lib -lglfw3 -framework Cocoa -framework OpenGL -framework IOKit -framework CoreVideo -lxlsxwriter -lmeltslibwin -lxml2 -lz -liconv -DGL_SILENCE_DEPRECATION -DEASYMELTS_UPDATE_SYSTEM
